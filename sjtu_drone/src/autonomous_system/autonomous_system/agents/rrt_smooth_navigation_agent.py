...
from trajectory_smoother import SmoothTrajectory, smooth_waypoints
from smooth_path_follower import SmoothPathFollower
...
class RRTSmoothNavigationAgent(SmoothPathFollower):
    ...
    def __init__(self):
        ...
        self.get_logger().info("RRT Smooth Navigation Agent ready on /navigate_rrt")
