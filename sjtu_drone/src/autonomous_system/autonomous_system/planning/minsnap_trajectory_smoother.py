...
Install: pip install minsnap-trajectories
"""
...
class SmoothTrajectory:
    ...
    def get_point(self, s: float) -> TrajectoryPoint:
        """
        Get state at arc length s (for compatibility with old interface).
...
def smooth_waypoints(
    ...
    Returns:
        SmoothTrajectory or None if generation fails
    """
    try:
        return SmoothTrajectory(waypoints_x, waypoints_y, waypoints_z, constraints)
