...
class TagBasedAzimuth(Node):
    ...
    def __init__(self):
        ...
        self.tag_config = {
            10: 90.0,   # Assuming Tag 10 is on the East Wall (90 degrees)
            11: 270.0,  # Assuming Tag 11 is on the West Wall (270 degrees)
            13: 0.0,    # Assuming Tag 13 is on the North Wall (0 degrees)
